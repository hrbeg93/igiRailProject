...
<body ng-app="">
<div id="">
<div class="jumbotron" style="background-image:  url(${pageContext.request.contextPath}/resources/image/rail1.jpg); height: 150px">
  <h3>Welcome To Railway Reservation System Admin Panel</h3>
